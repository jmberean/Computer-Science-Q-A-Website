...
<div class="container-fluid" style="background:WHITE;border-radius:10px;padding:10px">
  ...
  <div class="row">
    ...
    <h1 class="display-5" style="font-size: 15px;">Welcome <?php echo $row["firstName"];?>!</h1>
      <p class="lead">
      </p>
      ...
      <div class="container" >
      <p>
      <i class="fas fa-user mr-3"></i><?php echo $row["firstName"];?> <?php echo $row["lastName"];?></p>
      <p >
      <i class="fas fa-star mr-3"></i><?php echo $row["userName"];?></p>
      <hr class="my-4">

      <a class="btn-sm btn-primary" href="upQuestionsPage.php" role="button" style="font-size:13px">Post</a>
...
?>
    ...
    <h1 style="font-size:20px">Your Questions</h1>
    ...
    session_start();
    $userName = $_SESSION['userName'];
    $sql = "SELECT * FROM csteamQuestions WHERE userID = '$userName'";
    $result = $conn->query($sql);
